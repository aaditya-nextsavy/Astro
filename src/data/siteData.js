...
export const SERVICES = [
    {
        ...
        highlight:
            `Practical, non-destructive remedies to align your space with the five elements (Pancha Bhootas), ensuring your property becomes a powerhouse of prosperity.`,
        link: "/contact"
    },
    {
        id: "02",
        ...
        highlight:
            `Receive a clear map of your strengths, weaknesses, and the specific planetary periods (Dashas) that will define your major life chapters.`,
        link: "/contact"
    },
    {
        id: "03",
        ...
        highlight:
            `Get personalized recommendations, including suitable Rudraksha, specific mantra recitations, and gemstone guidance to reduce malefic influences and strengthen positive planetary transits.`,
        link: "/contact"
    },
    {
        id: "04",
        ...
        highlight:
            `Receive strategic guidance on when to take action, when to wait, and how to resolve relationship and career challenges through astrological understanding.`,
        link: "/contact"
    },
    {
        id: "05",
        ...
        highlight:
            `Benefit from bespoke spiritual toolkits, including Yantra energization and customized rituals tailored to your business goals and personal financial expansion.`,
        link: "/contact"
    },
    {
        id: "06",
        ...
        highlight:
            `Experience a blend of ancient spiritual wisdom and modern perspective to overcome anxiety, achieve emotional balance, and move forward with clarity.`,
        link: "/contact"
    },
    {
        id: "07",
        ...
        highlight:
            `From Gruha Pravesh to personalized Grah Shanti Pujas, we manage every aspect of the ritual so you can fully immerse yourself in the divine experience.`,
        link: "/contact"
    },
    {
        id: "08",
        ...
        highlight:
            `Participate in a powerful monthly energy-clearing ritual that dissolves negativity and creates the foundation for a fresh, empowered beginning.`,
        link: "/contact"
    },
];
...
export const FOOTER_SERVICES = [
    ...
    "Astrological Predictions & Effective Remedies",
    "Relationship and Career Guidance",
    "Custom Solutions for Prosperity and Growth",
    "Spiritual Counseling and Life Path Direction",
    "Authentic Puja Services",
    "Sarvabadha Nivaran Homa",
];
