      ...
      <main className="relative min-h-screen">
        ...
        >
          ...
          <div className={`mobile-drawer-menu ${menuOpen ? "open" : ""}`}>
            ...
            <div
              className="mobile-drawer-menu-backdrop"
              onClick={() => setMenuOpen(false)}
            />

            <div className="mobile-drawer-menu-panel">


              <nav className="mobile-drawer-menu-nav">

                <Link href="/about" onClick={() => setMenuOpen(false)}>About</Link>
                <Link href="/services" onClick={() => setMenuOpen(false)}>Services</Link>
                <Link href="/gallery" onClick={() => setMenuOpen(false)}>Gallery</Link>
                <Link href="/rudrax" onClick={() => setMenuOpen(false)}>Rudrax</Link>
